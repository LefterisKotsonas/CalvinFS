...
class PairSequenceDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<PairSequence> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  0,
  1,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PairSequence, _has_bits_),
...
void TableStruct::Shutdown() {
  ...
  _PairSequence_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _PairSequence_default_instance_.DefaultConstruct();
}
...
const ::google::protobuf::Descriptor* Scalar::descriptor() {
  protobuf_scalar_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_scalar_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata Scalar::GetMetadata() const {
  protobuf_scalar_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_scalar_2eproto::file_level_metadata[kIndexInFileMessages];
}
  ...
  for (unsigned int i = 0, n = this->pairs_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->pairs(i), deterministic, target);
  }
